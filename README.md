This repository contains code for the NeurIPS 2026 Evaluation & Datasets submission: **Evaluating Compositional Generalization in Transformers: The Role of Composition Equivalence and Module Coverage**.
